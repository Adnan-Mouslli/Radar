...
//     // عدم تحميل الفيديو مرة أخرى إذا كان قد تم تحميله بالفعل
//     if (preloadedVideos[id] == true || videoControllers.containsKey(id)) {
//       return;
//     }

//     // وضع علامة على أن الفيديو قيد التحميل المسبق
//     preloadedVideos[id] = true;

//     try {
//       // تكوين مشغل جديد مع إعدادات محسنة للتحميل المسبق
//       final betterPlayerConfiguration = BetterPlayerConfiguration(
//         autoPlay: false,
//         looping: false, // تعطيل التكرار للتحميل المسبق
//         fit: BoxFit.contain,
//         controlsConfiguration: BetterPlayerControlsConfiguration(
//           showControls: false,
//           enableOverflowMenu: false,
//         ),
//         handleLifecycle: false, // تعطيل معالجة دورة الحياة للتحميل المسبق
//         autoDispose: false,
//         startAt: Duration.zero,
//         allowedScreenSleep: true, // السماح للنوم أثناء التحميل المسبق
//       );
...
//           useCache: true,
//           maxCacheSize: 50 * 1024 * 1024, // زيادة حجم التخزين المؤقت
//           maxCacheFileSize: 10 * 1024 * 1024,
//           preCacheSize: 2 * 1024 * 1024, // زيادة حجم التحميل المسبق
//         ),
//         bufferingConfiguration: BetterPlayerBufferingConfiguration(
//             minBufferMs: 10000,
//             maxBufferMs: 30000, // وقت أقل للتحميل المسبق
...
//       // كتم الصوت دائماً أثناء التحميل المسبق
//       await controller.setVolume(0.0);
//       await controller.setupDataSource(betterPlayerDataSource);

//       // عدم تشغيل الفيديو، فقط التحميل المسبق
